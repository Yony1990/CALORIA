...
//   // ── PROTEÍNAS ──────────────────────────────────────────
//   { id:1,  name:'Pollo (pechuga)',       cat:'proteína',     cal:165, protein:31,  carbs:0,   fat:3.6, fiber:0,   icon:'🍗' },
//   { id:2,  name:'Huevo entero',          cat:'proteína',     cal:155, protein:13,  carbs:1.1, fat:11,  fiber:0,   icon:'🥚' },
//   { id:3,  name:'Atún en agua',          cat:'proteína',     cal:116, protein:26,  carbs:0,   fat:1,   fiber:0,   icon:'🐟' },
//   { id:4,  name:'Salmón',                cat:'proteína',     cal:208, protein:20,  carbs:0,   fat:13,  fiber:0,   icon:'🐠' },
//   { id:5,  name:'Carne de res',          cat:'proteína',     cal:250, protein:26,  carbs:0,   fat:15,  fiber:0,   icon:'🥩' },
//   { id:6,  name:'Cerdo (lomo)',          cat:'proteína',     cal:242, protein:27,  carbs:0,   fat:14,  fiber:0,   icon:'🥩' },
//   { id:7,  name:'Pollo (muslo)',         cat:'proteína',     cal:209, protein:26,  carbs:0,   fat:11,  fiber:0,   icon:'🍗' },
//   { id:8,  name:'Huevo frito',           cat:'proteína',     cal:196, protein:13,  carbs:0.4, fat:15,  fiber:0,   icon:'🍳' },
//   { id:9,  name:'Huevo revuelto',        cat:'proteína',     cal:149, protein:10,  carbs:1.6, fat:11,  fiber:0,   icon:'🍳' },
//   { id:10, name:'Sardinas en aceite',    cat:'proteína',     cal:208, protein:25,  carbs:0,   fat:11,  fiber:0,   icon:'🐟' },

//   // ── LÁCTEOS Y DESAYUNO ─────────────────────────────────
//   { id:11, name:'Leche entera',          cat:'lácteo',       cal:61,  protein:3.2, carbs:4.8, fat:3.3, fiber:0,   icon:'🥛' },
//   { id:12, name:'Leche descremada',      cat:'lácteo',       cal:35,  protein:3.4, carbs:5,   fat:0.2, fiber:0,   icon:'🥛' },
//   { id:13, name:'Café con leche',        cat:'lácteo',       cal:52,  protein:2.8, carbs:4.2, fat:2.8, fiber:0,   icon:'☕' },
//   { id:14, name:'Café negro (cortado)',  cat:'lácteo',       cal:8,   protein:0.3, carbs:1.5, fat:0,   fiber:0,   icon:'☕' },
//   { id:15, name:'Yogur griego',          cat:'lácteo',       cal:59,  protein:10,  carbs:3.6, fat:0.4, fiber:0,   icon:'🫙' },
//   { id:16, name:'Yogur natural',         cat:'lácteo',       cal:61,  protein:3.5, carbs:4.7, fat:3.3, fiber:0,   icon:'🫙' },
//   { id:17, name:'Queso cottage',         cat:'lácteo',       cal:98,  protein:11,  carbs:3.4, fat:4.3, fiber:0,   icon:'🧀' },
//   { id:18, name:'Queso fresco',          cat:'lácteo',       cal:264, protein:18,  carbs:3.4, fat:21,  fiber:0,   icon:'🧀' },
//   { id:19, name:'Mantequilla',           cat:'lácteo',       cal:717, protein:0.9, carbs:0.1, fat:81,  fiber:0,   icon:'🧈' },

//   // ── CARBOHIDRATOS ──────────────────────────────────────
//   { id:20, name:'Arroz blanco cocido',   cat:'carbohidrato', cal:130, protein:2.7, carbs:28,  fat:0.3, fiber:0.4, icon:'🍚' },
//   { id:21, name:'Arroz integral cocido', cat:'carbohidrato', cal:123, protein:2.7, carbs:25,  fat:1,   fiber:1.8, icon:'🍚' },
//   { id:22, name:'Avena',                 cat:'carbohidrato', cal:389, protein:17,  carbs:66,  fat:7,   fiber:10,  icon:'🌾' },
//   { id:23, name:'Pan blanco (rebanada)', cat:'carbohidrato', cal:266, protein:9,   carbs:51,  fat:3.2, fiber:2.7, icon:'🍞' },
//   { id:24, name:'Pan integral',          cat:'carbohidrato', cal:247, protein:9,   carbs:41,  fat:4,   fiber:7,   icon:'🍞' },
//   { id:25, name:'Pasta cocida',          cat:'carbohidrato', cal:131, protein:5,   carbs:25,  fat:1.1, fiber:1.8, icon:'🍝' },
//   { id:26, name:'Espagueti cocido',      cat:'carbohidrato', cal:158, protein:6,   carbs:31,  fat:0.9, fiber:1.8, icon:'🍝' },
//   { id:27, name:'Papa cocida',           cat:'carbohidrato', cal:77,  protein:2,   carbs:17,  fat:0.1, fiber:2.2, icon:'🥔' },
//   { id:28, name:'Papa frita (casera)',   cat:'carbohidrato', cal:312, protein:3.4, carbs:41,  fat:15,  fiber:3.5, icon:'🍟' },
//   { id:29, name:'Boniato cocido',        cat:'carbohidrato', cal:86,  protein:1.6, carbs:20,  fat:0.1, fiber:3,   icon:'🍠' },
//   { id:30, name:'Yuca cocida',           cat:'carbohidrato', cal:160, protein:1.4, carbs:38,  fat:0.3, fiber:1.8, icon:'🫚' },
//   { id:31, name:'Plátano maduro frito',  cat:'carbohidrato', cal:310, protein:1.3, carbs:48,  fat:14,  fiber:2.3, icon:'🍌' },
//   { id:32, name:'Tostada (pan blanco)',  cat:'carbohidrato', cal:313, protein:10,  carbs:59,  fat:4,   fiber:2.4, icon:'🍞' },
//   { id:33, name:'Galletas de agua',      cat:'carbohidrato', cal:421, protein:9,   carbs:74,  fat:9,   fiber:2.2, icon:'🫓' },

//   // ── LEGUMBRES (cubanas/uruguayas) ──────────────────────
//   { id:34, name:'Frijoles negros cocidos',  cat:'legumbre',  cal:132, protein:8.9, carbs:23,  fat:0.5, fiber:8.7, icon:'🫘' },
//   { id:35, name:'Frijoles colorados',       cat:'legumbre',  cal:127, protein:8.7, carbs:22,  fat:0.5, fiber:7.4, icon:'🫘' },
//   { id:36, name:'Lentejas cocidas',         cat:'legumbre',  cal:116, protein:9,   carbs:20,  fat:0.4, fiber:7.9, icon:'🫘' },
//   { id:37, name:'Porotos (alubias)',        cat:'legumbre',  cal:127, protein:8.7, carbs:22,  fat:0.5, fiber:6.4, icon:'🫘' },
//   { id:38, name:'Garbanzos cocidos',        cat:'legumbre',  cal:164, protein:8.9, carbs:27,  fat:2.6, fiber:7.6, icon:'🫘' },
//   { id:39, name:'Potaje de frijoles',       cat:'legumbre',  cal:95,  protein:6,   carbs:16,  fat:1.2, fiber:5.5, icon:'🍲' },

//   // ── COMIDAS TÍPICAS ────────────────────────────────────
//   { id:40, name:'Ropa vieja (200g)',        cat:'plato',     cal:290, protein:28,  carbs:12,  fat:14,  fiber:2.5, icon:'🍲' },
//   { id:41, name:'Arroz con pollo (300g)',   cat:'plato',     cal:380, protein:29,  carbs:42,  fat:8,   fiber:2,   icon:'🍛' },
//   { id:42, name:'Milanesa de res',          cat:'plato',     cal:320, protein:28,  carbs:18,  fat:14,  fiber:0.8, icon:'🥩' },
//   { id:43, name:'Milanesa de pollo',        cat:'plato',     cal:280, protein:30,  carbs:16,  fat:10,  fiber:0.5, icon:'🍗' },
//   { id:44, name:'Churrasco (200g)',         cat:'plato',     cal:360, protein:38,  carbs:0,   fat:22,  fiber:0,   icon:'🥩' },
//   { id:45, name:'Asado de tira (200g)',     cat:'plato',     cal:420, protein:34,  carbs:0,   fat:31,  fiber:0,   icon:'🥩' },
//   { id:46, name:'Pasta con salsa roja',     cat:'plato',     cal:280, protein:10,  carbs:48,  fat:6,   fiber:3.5, icon:'🍝' },
//   { id:47, name:'Pasta con carne molida',   cat:'plato',     cal:380, protein:22,  carbs:45,  fat:12,  fiber:3,   icon:'🍝' },
//   { id:48, name:'Sopa de pollo (300ml)',    cat:'plato',     cal:85,  protein:8,   carbs:7,   fat:2.5, fiber:1,   icon:'🍜' },
//   { id:49, name:'Caldo de res (300ml)',     cat:'plato',     cal:45,  protein:6,   carbs:2,   fat:1.5, fiber:0,   icon:'🍜' },
//   { id:50, name:'Tostadas con mantequilla', cat:'plato',     cal:210, protein:4,   carbs:26,  fat:10,  fiber:1.5, icon:'🍞' },
//   { id:51, name:'Pan con queso',            cat:'plato',     cal:290, protein:12,  carbs:30,  fat:14,  fiber:1.5, icon:'🧀' },
//   { id:52, name:'Sandwich de jamon',        cat:'plato',     cal:320, protein:18,  carbs:34,  fat:12,  fiber:2,   icon:'🥪' },
//   { id:53, name:'Croquetas de jamón (3u)',  cat:'plato',     cal:210, protein:9,   carbs:22,  fat:10,  fiber:0.5, icon:'🫓' },
//   { id:54, name:'Tamales (1 unidad)',       cat:'plato',     cal:285, protein:10,  carbs:38,  fat:10,  fiber:3.5, icon:'🌽' },
//   { id:55, name:'Tortilla española',        cat:'plato',     cal:218, protein:11,  carbs:14,  fat:13,  fiber:1.2, icon:'🍳' },
//   { id:56, name:'Chivito uruguayo',         cat:'plato',     cal:680, protein:42,  carbs:45,  fat:32,  fiber:3,   icon:'🥪' },
//   { id:57, name:'Empanada de carne (1u)',   cat:'plato',     cal:290, protein:14,  carbs:28,  fat:13,  fiber:1.5, icon:'🥟' },
//   { id:58, name:'Empanada de queso (1u)',   cat:'plato',     cal:260, protein:10,  carbs:27,  fat:13,  fiber:1,   icon:'🥟' },
//   { id:59, name:'Moros y Cristianos',       cat:'plato',     cal:185, protein:8,   carbs:35,  fat:2,   fiber:5,   icon:'🍚' },
//   { id:60, name:'Picadillo a la criolla',   cat:'plato',     cal:240, protein:22,  carbs:10,  fat:12,  fiber:2,   icon:'🍲' },

//   // ── VERDURAS ───────────────────────────────────────────
//   { id:61, name:'Brócoli',               cat:'verdura',      cal:34,  protein:2.8, carbs:7,   fat:0.4, fiber:2.6, icon:'🥦' },
//   { id:62, name:'Espinaca',              cat:'verdura',      cal:23,  protein:2.9, carbs:3.6, fat:0.4, fiber:2.2, icon:'🥬' },
//   { id:63, name:'Tomate',                cat:'verdura',      cal:18,  protein:0.9, carbs:3.9, fat:0.2, fiber:1.2, icon:'🍅' },
//   { id:64, name:'Zanahoria',             cat:'verdura',      cal:41,  protein:0.9, carbs:10,  fat:0.2, fiber:2.8, icon:'🥕' },
//   { id:65, name:'Lechuga',               cat:'verdura',      cal:15,  protein:1.4, carbs:2.9, fat:0.2, fiber:1.8, icon:'🥬' },
//   { id:66, name:'Cebolla',               cat:'verdura',      cal:40,  protein:1.1, carbs:9,   fat:0.1, fiber:1.7, icon:'🧅' },
//   { id:67, name:'Pepino',                cat:'verdura',      cal:15,  protein:0.7, carbs:3.6, fat:0.1, fiber:0.5, icon:'🥒' },
//   { id:68, name:'Pimiento',              cat:'verdura',      cal:31,  protein:1,   carbs:6,   fat:0.3, fiber:2.1, icon:'🫑' },
//   { id:69, name:'Calabaza',              cat:'verdura',      cal:26,  protein:1,   carbs:6.5, fat:0.1, fiber:0.5, icon:'🎃' },

//   // ── FRUTAS ─────────────────────────────────────────────
//   { id:70, name:'Manzana',               cat:'fruta',        cal:52,  protein:0.3, carbs:14,  fat:0.2, fiber:2.4, icon:'🍎' },
//   { id:71, name:'Banano/Plátano',        cat:'fruta',        cal:89,  protein:1.1, carbs:23,  fat:0.3, fiber:2.6, icon:'🍌' },
//   { id:72, name:'Naranja',               cat:'fruta',        cal:47,  protein:0.9, carbs:12,  fat:0.1, fiber:2.4, icon:'🍊' },
//   { id:73, name:'Mango',                 cat:'fruta',        cal:60,  protein:0.8, carbs:15,  fat:0.4, fiber:1.6, icon:'🥭' },
//   { id:74, name:'Papaya/Fruta bomba',    cat:'fruta',        cal:43,  protein:0.5, carbs:11,  fat:0.3, fiber:1.7, icon:'🍈' },
//   { id:75, name:'Guayaba',               cat:'fruta',        cal:68,  protein:2.6, carbs:14,  fat:1,   fiber:5.4, icon:'🍏' },
//   { id:76, name:'Piña',                  cat:'fruta',        cal:50,  protein:0.5, carbs:13,  fat:0.1, fiber:1.4, icon:'🍍' },
//   { id:77, name:'Fresa',                 cat:'fruta',        cal:32,  protein:0.7, carbs:7.7, fat:0.3, fiber:2,   icon:'🍓' },
//   { id:78, name:'Sandía',                cat:'fruta',        cal:30,  protein:0.6, carbs:7.6, fat:0.2, fiber:0.4, icon:'🍉' },

//   // ── GRASAS Y EXTRAS ────────────────────────────────────
//   { id:79, name:'Aguacate',              cat:'grasa',        cal:160, protein:2,   carbs:9,   fat:15,  fiber:7,   icon:'🥑' },
//   { id:80, name:'Almendras',             cat:'grasa',        cal:579, protein:21,  carbs:22,  fat:50,  fiber:12,  icon:'🌰' },
//   { id:81, name:'Aceite de oliva',       cat:'grasa',        cal:884, protein:0,   carbs:0,   fat:100, fiber:0,   icon:'🫒' },
//   { id:82, name:'Aceite vegetal',        cat:'grasa',        cal:884, protein:0,   carbs:0,   fat:100, fiber:0,   icon:'🧴' },
//   { id:83, name:'Mayonesa',              cat:'grasa',        cal:680, protein:1,   carbs:0.6, fat:75,  fiber:0,   icon:'🥄' },
//   { id:84, name:'Azúcar blanca',         cat:'extra',        cal:387, protein:0,   carbs:100, fat:0,   fiber:0,   icon:'🍬' },
//   { id:85, name:'Miel',                  cat:'extra',        cal:304, protein:0.3, carbs:82,  fat:0,   fiber:0.2, icon:'🍯' },
// ];
